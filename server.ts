...
express.static.mime.define({'application/javascript': ['js', 'cjs', 'mjs']});
  ...
  app.get("/api/now-playing", (req, res) => {
    ...
    const channels = [
      ...
      { number: 101, name: "AJN NIGHTLY NEWS", category: "News", url: "https://archive.org/download/RT_20260630_000000_News/RT_20260630_000000_News.mp4" },
...
app.get("/api/ajn-archive", async (req, res) => {
    ...
    const BACKUP_EPISODES = [
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_WarRoom-Hr3.m4v",
        title: "VIDEO - 20260708_Wed_WarRoom-Hr3",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_WarRoom-Hr3.m4v",
      ...
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_WarRoom-Hr2.m4v",
        title: "VIDEO - 20260708_Wed_WarRoom-Hr2",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_WarRoom-Hr2.m4v",
      ...
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_WarRoom-Hr1.m4v",
        title: "VIDEO - 20260708_Wed_WarRoom-Hr1",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_WarRoom-Hr1.m4v",
        pubDate: "2026-07-08T20:00:00.000Z",
        dateKey: "2026-07-08",
        show: "War Room",
        hour: "Hour 1"
      },
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr4.m4v",
        title: "VIDEO - 20260708_Wed_Alex-Hr4",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr4.m4v",
      ...
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr3.m4v",
        title: "VIDEO - 20260708_Wed_Alex-Hr3",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr3.m4v",
      ...
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr2.m4v",
        title: "VIDEO - 20260708_Wed_Alex-Hr2",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr2.m4v",
      ...
      {
        id: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr1.m4v",
        title: "VIDEO - 20260708_Wed_Alex-Hr1",
        videoUrl: "https://ajn.archives.pub/hourly-m4v/20260708_Wed_Alex-Hr1.m4v",
        pubDate: "2026-07-08T16:00:00.000Z",
        dateKey: "2026-07-08",
        show: "Alex Jones Show",
        hour: "Hour 1"
      }
